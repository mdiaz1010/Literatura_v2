				...
				<div class="section-title title-ex1">
					...
					<p class="description text-justify" >
						...
						<div class="text-center">
							...
							<form action="<?=base_url('Welcome/nosotros')?>">

								<button class="btn btn-primary-outlined" type="submit"><i class="fa fa-plus"></i> Ver más</button>
...
<section class="home-services bg-sand hero-block home-about">
	<div class="container">
		...
		<div class="row">
			...
			<br>
					<div class="text-center">
						<form action="<?=base_url('Welcome/servicios')?>">
						<button class="btn btn-primary-outlined" type="submit"><i class="fa fa-plus"></i> Ver más</button>
						</form>
					</div>
				</p>
