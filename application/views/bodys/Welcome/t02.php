			...
			<div class="row">
				<div class="col-lg-3 col-md-4">
					<div class="img-container">
						<img src="<?=base_url("publico/images/about/equipo004.jpg")?>" alt="Corrección de tesis, tesinas u otros textos académicos" class="img-full">
					</div>
				</div>
							...
							<div class="row">
								...
								<div class="col-lg-2">
									<div class="social-icons">
										<a href="https://www.facebook.com/papacorrectores/" target='_blank' class="btn btn-social outlined"><i class="fa fa-facebook-f"></i></a>
									</div>
								</div>
							</div>
						</div>
